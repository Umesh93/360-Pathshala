  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div>
          <label className="mb-1 block text-sm font-medium text-gray-700">Admission Number</label>
          <input
            type="text"
        ...
        <div>
          <label className="mb-1 block text-sm font-medium text-gray-700">Admission Date</label>
          <input
            type="date"
        ...
        <div>
          <label className="mb-1 block text-sm font-medium text-gray-700">House</label>
          <select
            value={data.house}
        ...
        <div>
          <label className="mb-1 block text-sm font-medium text-gray-700">Student Status</label>
          <select
            value={data.status}
        ...
        <div>
          <label className="mb-1 block text-sm font-medium text-gray-700">Scholarship</label>
          <input
            type="text"
