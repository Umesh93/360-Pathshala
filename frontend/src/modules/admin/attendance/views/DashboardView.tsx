...
export default function DashboardView() {
  ...
  const stats = [
    ...
    ["Students Absent Today", data.absent, UserX, "text-red-600 bg-red-50"],
    [
    ...
    ["Late Arrivals", data.late, Clock3, "text-amber-600 bg-amber-50"],
    [
      "Approved Leaves",
      data.approvedLeaves,
      CalendarCheck,
      ...
      <div className="flex justify-end">
        <label className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <input
            ...
            className="h-10 rounded-lg border border-gray-200 bg-white px-3"
          />
        </label>
      </div>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {stats.map(([label, value, Icon, style]) => (
          <div className={`${cardClass} p-5`} key={label}>
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-3">
        <section className={`${cardClass} p-5 xl:col-span-2`}>
          ...
          <p className="mb-4 text-sm text-gray-500">
            Present and absent students over time
          </p>
          <div className="h-72">
              ...
              <AreaChart data={data.trend}>
                <defs>
                  <linearGradient id="presentFill" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#234A91" stopOpacity={0.25} />
                    <stop offset="95%" stopColor="#234A91" stopOpacity={0} />
                  </linearGradient>
                </defs>
