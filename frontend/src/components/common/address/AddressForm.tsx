...
export default function AddressForm<T extends AddressValue>({
  data,
  onChange,
  errors = {},
}: AddressFormProps<T>) {
  ...
  useEffect(() => {
    const provinceId = Number(
      selectedId(data.permanentProvince || "", provinces),
    );
  ...
  const fieldClass = (error?: string) =>
    `h-10 w-full rounded-xl border px-3 text-sm outline-none focus:border-[#234A91] focus:ring-2 focus:ring-blue-100 disabled:bg-gray-100 ${error ? "border-red-500" : "border-gray-200"}`;
  ...
  const permanentProvinceId = selectedId(
    data.permanentProvince || "",
    provinces,
  );
  const permanentDistrictId = selectedId(
    data.permanentDistrict || "",
    permanentDistricts,
  );

  const copyCurrent = (checked: boolean) =>
    onChange({
      ...data,
      ...
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            <div>
              ...
              <select
                ...
                className={fieldClass(errors.currentProvince)}
                aria-required="true"
                aria-invalid={!!errors.currentProvince}
              >
                <option value="">
                  {provinceLoading ? "Loading..." : "Select Province"}
                </option>
                {provinces.map((item) => (
            ...
            <div>
              ...
              <select
                ...
                onChange={(event) => {
                  const item = currentDistricts.find(
                    (option) => String(option.id) === event.target.value,
                  );
                  onChange({
                    ...data,
                    currentDistrict: event.target.value,
                    currentDistrictName: item?.name || "",
                  });
                }}
                disabled={!data.currentProvince || currentDistrictLoading}
                className={fieldClass(errors.currentDistrict)}
                aria-required="true"
                aria-invalid={!!errors.currentDistrict}
              >
                <option value="">
                  {currentDistrictLoading ? "Loading..." : "Select District"}
                </option>
            ...
            <div>
              ...
              <input
                data-field="currentMunicipality"
                type="text"
                value={data.currentMunicipality}
                onChange={(event) =>
                  onChange({
                    ...data,
                    currentMunicipality: event.target.value,
                    currentMunicipalityName: event.target.value,
                  })
                }
                className={fieldClass(errors.currentMunicipality)}
                aria-required="true"
                aria-invalid={!!errors.currentMunicipality}
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(event) =>
                  onChange({
                    ...data,
                    currentWard: event.target.value,
                    currentWardNumber: event.target.value,
                  })
                }
                className={fieldClass(errors.currentWard)}
                aria-required="true"
                aria-invalid={!!errors.currentWard}
              />
            ...
            <div>
              ...
              <input
                data-field="currentStreet"
                type="text"
                value={data.currentStreet || ""}
                onChange={(event) =>
                  onChange({ ...data, currentStreet: event.target.value })
                }
        ...
        <label className="flex items-center gap-2 text-sm text-gray-700">
          <input
            ...
            onChange={(event) => copyCurrent(event.target.checked)}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(event) => {
                    ...
                    onChange({
                      ...data,
                      permanentProvince: event.target.value,
                      permanentProvinceName: item?.name || "",
                      permanentDistrict: "",
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(event) => {
                    const item = permanentDistricts.find(
                      (option) => String(option.id) === event.target.value,
                    );
                    onChange({
                      ...data,
                      permanentDistrict: event.target.value,
                      permanentDistrictName: item?.name || "",
                    });
                  }}
                  disabled={!data.permanentProvince || permanentDistrictLoading}
                  className={fieldClass()}
                >
                  <option value="">
              ...
              <div>
                ...
                <input
                  data-field="permanentMunicipality"
                  type="text"
                  value={data.permanentMunicipality || ""}
                  onChange={(event) =>
                    onChange({
                      ...data,
                      permanentMunicipality: event.target.value,
                    })
                  }
                  className={fieldClass()}
                />
              ...
              <div>
                ...
                <input
                  data-field="permanentWard"
                  type="number"
                  min={1}
                  max={35}
                  value={data.permanentWard || ""}
                  onChange={(event) =>
                    onChange({ ...data, permanentWard: event.target.value })
                  }
                  className={fieldClass()}
                />
              </div>
              <div>
                ...
                <input
                  data-field="permanentStreet"
                  type="text"
                  value={data.permanentStreet || ""}
                  onChange={(event) =>
                    onChange({ ...data, permanentStreet: event.target.value })
                  }
                  className={fieldClass()}
                />
              </div>
