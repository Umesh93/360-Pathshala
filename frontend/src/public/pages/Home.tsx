        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 pb-20 pt-16 lg:grid-cols-2 lg:gap-16 lg:px-10 lg:pt-24">
          <motion.div initial="hidden" animate="show" variants={fadeUp}>
            <span className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-4 py-1.5 text-xs font-medium text-foreground/70 shadow-soft">
              <Sparkles className="h-3.5 w-3.5 text-accent" />A 360° Student
              Management System
            </span>
            <h1 className="mt-6 font-display text-5xl font-extrabold leading-[1.05] tracking-tight text-foreground sm:text-6xl lg:text-7xl">
              ...
              <span className="text-gradient-accent">modern learning</span>.
            </h1>
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              360 Pathshala digitizes every part of academic life — from
              attendance and assignments to results and communication — through
              a single, beautiful, modular platform.
            </p>
                ...
                <div className="mt-6 grid grid-cols-3 gap-3">
                  {[
                    ...
                    >
                      ...
                      <p
                        className={`mt-1 font-display text-2xl font-bold ${s.tone}`}
                      >
                        {s.value}
                      </p>
                    </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Carefully crafted modules that work beautifully on their own — and
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_1.4fr] lg:gap-16">
            <div>
              ...
              <p className="mt-5 text-muted-foreground">
                360 Pathshala follows a clean role-based flow. Super Admin
                enables paid modules, schools manage users, and everyone else
                just teaches and learns.
              </p>
              <Link
                to="/demo"
      ...
      <section className="bg-surface">
        <div className="mx-auto max-w-5xl px-6 py-24 text-center lg:px-10">
          ...
          <blockquote className="mt-6 font-display text-3xl font-medium leading-snug text-foreground sm:text-4xl">
            “360 Pathshala feels like the school itself was redesigned around
            clarity. Our teachers spend less time on paperwork and more time
            teaching.”
          </blockquote>
        ...
        <div className="relative mx-auto max-w-6xl overflow-hidden rounded-3xl bg-gradient-brand p-10 shadow-elevated md:p-16">
          ...
          <div className="relative flex flex-col items-center justify-center text-center">
            ...
            <p className="mt-4 max-w-xl text-primary-foreground/80">
              Schedule a personalized demo and see how 360 Pathshala fits your
              institution — only the modules you need, nothing more.
            </p>
